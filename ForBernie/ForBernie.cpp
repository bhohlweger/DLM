...
void RUN2_main(const unsigned& NumIter, const unsigned& NumJobs, const unsigned& JobID){
	...
	FemtoRegion_pXim[0][0]=8; FemtoRegion_pXim[0][1]=180;
	FemtoRegion_pXim[1][0]=8; FemtoRegion_pXim[1][1]=220;
	FemtoRegion_pXim[2][0]=8; FemtoRegion_pXim[2][1]=260;
	...
	if(DataPeriod=="pp13TeV"){
		...
		printf("FUCK YOU! Stirb du Wicht! Fat incular! !\n");
		return;
	}
	...
	const unsigned NumMomBins_pL = 22;
	const double kMin_pL = 0;
	const double kMax_pL = kMin_pL+12*NumMomBins_pL;

	const unsigned NumMomBins_LL = 22;
	const double kMin_LL = 0;
	const double kMax_LL = kMin_LL+12*NumMomBins_LL;

	const unsigned NumMomBins_pXim = 22;
	const double kMin_pXim = 8;
	const double kMax_pXim = kMin_pXim+12*NumMomBins_pXim;
	...
	double pXimPotParsI0S0[10]={0,0,pXim_Lattice,12,0,-1,1,0,0,0};//4th argument is the t parameter and can be:
	double pXimPotParsI0S1[10]={0,0,pXim_Lattice,12,0,-1,1,1,0,1};// 9, 10, 11, 12
	double pXimPotParsI1S0[10]={0,0,pXim_Lattice,6,1,1,1,0,0,0};//This is shit. Corresponds to 9-14 t
	double pXimPotParsI1S1[10]={0,0,pXim_Lattice,6,1,1,1,1,0,1};// this value 1-6
	CATS AB_pXim;
	...
	const TString ResMatrixFileName = "/Users/bernhardhohlweger/Dropbox/FastForwardFemto/CATS_Files/DecayMatrices/run2_decay_matrices_old.root";
	//location of the file containing the momentum smearing matrices
	const TString SigmaMatrixFileName =
			DataPeriod=="pp13TeV"?  "/Users/bernhardhohlweger/Dropbox/FastForwardFemto/CATS_Files/ALICE_pp_13TeV/ResolutionMatrices/Sample6_MeV_compact.root":"/Users/bernhardhohlweger/Dropbox/FastForwardFemto/CATS_Files/ALICE_pPb_5TeV/ResolutionMatrices/Sample3_MeV_compact.root";
	...
	for(unsigned uIter=FirstIter; uIter<=LastIter; uIter++){
		...
		//				DataPeriod=="pp13TeV"?TString::Format("/Users/bernhardhohlweger/Dropbox/FastForwardFemto/CATS_Files/ALICE_pp_13TeV/Sample6/AnalysisResults_AndiBernieSystME_CkProtonProton_%u.root",vCutID):
		//						TString::Format("/Users/bernhardhohlweger/Dropbox/RunFiles/newInput/AnalysisResults_AndiBernieSystME_CkProtonProton_%u.root",vCutID);
//		TString OliFileName_pp =
//				DataPeriod=="pp13TeV"?TString::Format("/Users/bernhardhohlweger/Dropbox/FastForwardFemto/CATS_Files/ALICE_pp_13TeV/Sample6/AnalysisResults_AndiBernieSystME_CkProtonProton_%u.root",vCutID):
//						TString::Format("/Users/bernhardhohlweger/Dropbox/FastForwardFemto/CATS_Files/ALICE_pPb_5TeV/Sample3/AnalysisResults_AndiBernieSystME_CkProtonProton_%u.root",vCutID);
		TString OliFileName_pp =
				DataPeriod=="pp13TeV"?TString::Format("/Users/bernhardhohlweger/Dropbox/FastForwardFemto/CATS_Files/ALICE_pp_13TeV/Sample6/AnalysisResults_AndiBernieSystME_CkProtonProton_%u.root",vCutID):
						TString::Format("/Users/bernhardhohlweger/Dropbox/FastForwardFemto/CATS_Files/ALICE_pPb_5TeV/FullStatistic/AnalysisResults_AndiBernieSystME_CkProtonProton_%u.root",vCutID);
		...
		TString SystErrFileName_pp =
				DataPeriod=="pp13TeV"?TString::Format("/Users/bernhardhohlweger/Dropbox/FastForwardFemto/CATS_Files/ALICE_pp_13TeV/Sample6/C2totalsysPP.root"):
						TString::Format("/Users/bernhardhohlweger/Dropbox/FastForwardFemto/CATS_Files/ALICE_pPb_5TeV/Sample3/C2totalsysPP.root");
		...
		//				DataPeriod=="pp13TeV"?TString::Format("/Users/bernhardhohlweger/Dropbox/FastForwardFemto/CATS_Files/ALICE_pp_13TeV/Sample6/AnalysisResults_AndiBernieSystME_CkProtonLambda_%u.root",vCutID):
		//						TString::Format("/Users/bernhardhohlweger/Dropbox/RunFiles/newInput/AnalysisResults_AndiBernieSystME_CkProtonLambda_%u.root",vCutID);
//		TString OliFileName_pL =
//				DataPeriod=="pp13TeV"?TString::Format("/Users/bernhardhohlweger/Dropbox/FastForwardFemto/CATS_Files/ALICE_pp_13TeV/Sample6/AnalysisResults_AndiBernieSystME_CkProtonLambda_%u.root",vCutID):
//						TString::Format("/Users/bernhardhohlweger/Dropbox/FastForwardFemto/CATS_Files/ALICE_pPb_5TeV/Sample3/AnalysisResults_AndiBernieSystME_CkProtonLambda_%u.root",vCutID);
		TString OliFileName_pL =
				DataPeriod=="pp13TeV"?TString::Format("/Users/bernhardhohlweger/Dropbox/FastForwardFemto/CATS_Files/ALICE_pp_13TeV/Sample6/AnalysisResults_AndiBernieSystME_CkProtonLambda_%u.root",vCutID):
						TString::Format("/Users/bernhardhohlweger/Dropbox/FastForwardFemto/CATS_Files/ALICE_pPb_5TeV/FullStatistic/AnalysisResults_AndiBernieSystME_CkProtonLambda_%u.root",vCutID);
		...
		TString SystErrFileName_pL =
				DataPeriod=="pp13TeV"?TString::Format("/Users/bernhardhohlweger/Dropbox/FastForwardFemto/CATS_Files/ALICE_pp_13TeV/Sample6/C2totalsysPL.root"):
						TString::Format("/Users/bernhardhohlweger/Dropbox/FastForwardFemto/CATS_Files/ALICE_pPb_5TeV/Sample3/C2totalsysPL.root");
		...
		//				DataPeriod=="pp13TeV"?TString::Format("/Users/bernhardhohlweger/Dropbox/FastForwardFemto/CATS_Files/ALICE_pp_13TeV/Sample6/AnalysisResults_AndiBernieSystME_CkLambdaLambda_%u.root",vCutID):
		//						TString::Format("/Users/bernhardhohlweger/Dropbox/RunFiles/newInput/AnalysisResults_AndiBernieSystME_CkLambdaLambda_%u.root",vCutID);
//		TString OliFileName_LL =
//				DataPeriod=="pp13TeV"?TString::Format("/Users/bernhardhohlweger/Dropbox/FastForwardFemto/CATS_Files/ALICE_pp_13TeV/Sample6/AnalysisResults_AndiBernieSystME_CkLambdaLambda_%u.root",vCutID):
//						TString::Format("/Users/bernhardhohlweger/Dropbox/FastForwardFemto/CATS_Files/ALICE_pPb_5TeV/Sample3/AnalysisResults_AndiBernieSystME_CkLambdaLambda_%u.root",vCutID);
		TString OliFileName_LL =
				DataPeriod=="pp13TeV"?TString::Format("/Users/bernhardhohlweger/Dropbox/FastForwardFemto/CATS_Files/ALICE_pp_13TeV/Sample6/AnalysisResults_AndiBernieSystME_CkLambdaLambda_%u.root",vCutID):
						TString::Format("/Users/bernhardhohlweger/Dropbox/FastForwardFemto/CATS_Files/ALICE_pPb_5TeV/FullStatistic/AnalysisResults_AndiBernieSystME_CkLambdaLambda_%u.root",vCutID);
		...
		TString SystErrFileName_LL =
				DataPeriod=="pp13TeV"?TString::Format("/Users/bernhardhohlweger/Dropbox/FastForwardFemto/CATS_Files/ALICE_pp_13TeV/Sample6/C2totalsysLL.root"):
						TString::Format("/Users/bernhardhohlweger/Dropbox/FastForwardFemto/CATS_Files/ALICE_pPb_5TeV/Sample3/C2totalsysLL.root");
...
//				DataPeriod=="pp13TeV"?TString::Format("/Users/bernhardhohlweger/Dropbox/FastForwardFemto/CATS_Files/ALICE_pp_13TeV/Sample6/AnalysisResults_AndiBernieSystME_CkProtonXim_%u.root",vCutID):
//						TString::Format("/Users/bernhardhohlweger/Dropbox/RunFiles/newInput/AnalysisResults_AndiBernieSystME_CkProtonXim_%u.root",vCutID);
//		TString OliFileName_pXim =
//				DataPeriod=="pp13TeV"?TString::Format("/Users/bernhardhohlweger/Dropbox/FastForwardFemto/CATS_Files/ALICE_pp_13TeV/Sample6/AnalysisResults_AndiBernieSystME_CkProtonXim_%u.root",vCutID):
//						TString::Format("/Users/bernhardhohlweger/Dropbox/FastForwardFemto/CATS_Files/ALICE_pPb_5TeV/Sample3/AnalysisResults_AndiBernieSystME_CkProtonXim_%u.root",vCutID);
//		TString OliFileName_pXim =
//				DataPeriod=="pp13TeV"?TString::Format("/Users/bernhardhohlweger/Dropbox/FastForwardFemto/CATS_Files/ALICE_pp_13TeV/Sample6/AnalysisResults_AndiBernieSystME_CkProtonXim_%u.root",vCutID):
//						TString::Format("/Users/bernhardhohlweger/Dropbox/FastForwardFemto/CATS_Files/ALICE_pPb_5TeV/FullStatistic/AnalysisResults_AndiBernieSystME_CkProtonXim_%u.root",vCutID);
		TString OliFileName_pXim =
				DataPeriod=="pp13TeV"?TString::Format("/Users/bernhardhohlweger/Dropbox/FastForwardFemto/CATS_Files/ALICE_pp_13TeV/Sample6/AnalysisResults_AndiBernieSystME_CkProtonXim_%u.root",vCutID):
						TString::Format("/Users/bernhardhohlweger/Dropbox/FastForwardFemto/CATS_Files/ALICE_pPb_5TeV/FullStatistic_Shifted/AnalysisResults_AndiBernieSystME_CkProtonXim_%u.root",vCutID);
		if(ExcludeXi) OliFileName_pXim="";
		TString OliHistoName_pXim = "hCkTotNormWeight_Shifted";
		...
		TH1F* OliHisto_woSys_pXim;
		if (OliHisto_pXim) {
			OliHistoName_pXim+="woSys";
			//        	std::cout << OliHistoName_pXim << std::endl;
			OliHisto_woSys_pXim=(TH1F*) OliHisto_pXim->Clone();
		}

		//!CHANGE PATH HERE
		TString SystErrFileName_pXim =
				DataPeriod=="pp13TeV"?"/Users/bernhardhohlweger/Dropbox/FastForwardFemto/CATS_Files/ALICE_pp_13TeV/Sample6/C2totalsysPXi.root":
						"/Users/bernhardhohlweger/Dropbox/FastForwardFemto/CATS_Files/ALICE_pPb_5TeV/Sample3/C2totalsysPXi.root";
		...
		if(!ExcludeXi){
			...
			for(int iBin=0; iBin<NumSEB_pXim; iBin++){
				if(SystematicsType=="CutVarIterate") continue;
				//                std::cout << "Stat: " << OliHisto_pXim->GetBinError(iBin+1) << " Sys: " << SystErrHisto_pXim->GetBinContent(iBin+1) << " total: "
				//                		<< sqrt(pow(OliHisto_pXim->GetBinError(iBin+1),2.)+pow(SystErrHisto_pXim->GetBinContent(iBin+1),2.)) << std::endl;
		...
		fitter->SetOutputDir("/Users/bernhardhohlweger/CATSOutput/tmp");
...
//		for(unsigned uBin=0; uBin<8; uBin++){
			...
			if(mom!=theoryX) printf("PROBLEM!\n");
//			if(uBin==3) {
//				std::cout << "ommitting bin with momentum" << theoryX << std::endl;
//				continue;
//			}
//			dataY = OliHisto_woSys_pXim->GetBinContent(uBin+1);
//			dataErr = OliHisto_woSys_pXim->GetBinError(uBin+1);
...
//		EffNumBins_pXim--;
		...
		std::cout << "float ppBL0 =" 		<< fitter->GetParameter("pp",DLM_Fitter1::p_a) << ";"<< std::endl;
		std::cout << "float ppBL1 =" 		<< fitter->GetParameter("pp",DLM_Fitter1::p_b) << ";"<< std::endl;

		std::cout << "float pLBL0 = " 		<< fitter->GetParameter("pLambda",DLM_Fitter1::p_a) << ";"<< std::endl;
		std::cout << "float pLBL1 = " 		<< fitter->GetParameter("pLambda",DLM_Fitter1::p_b) << ";"<< std::endl;

		std::cout << "float LLBL0 = " 		<< fitter->GetParameter("LambdaLambda",DLM_Fitter1::p_a) << ";"<< std::endl;
		std::cout << "float LLBL1 = " 		<< fitter->GetParameter("LambdaLambda",DLM_Fitter1::p_b) << ";"<< std::endl;

		std::cout << "float pXiBL0 = " 		<< fitter->GetParameter("pXim",DLM_Fitter1::p_a) << ";"<< std::endl;
		std::cout << "float pXiBL1 = " 		<< fitter->GetParameter("pXim",DLM_Fitter1::p_b) << ";"<< std::endl;
...
//		EffNumBins_pXim_COULOMB--;
		if(FAST_PLOT){
			...
			info2->AddText(TString::Format("Local #chi^{2}/ndf=%.0f/%u=%.2f, p_{val}=%.3f",
					Chi2_pL,EffNumBins_pL,Chi2_pL/double(EffNumBins_pL),TMath::Prob(Chi2_pL,round(EffNumBins_pL))));
			info2->AddText(TString::Format("LO #chi^{2}/ndf=%.0f/%u=%.2f, p_{val}=%.3f",
					Chi2_pL_LO,EffNumBins_pL,Chi2_pL_LO/double(EffNumBins_pL),TMath::Prob(Chi2_pL_LO,round(EffNumBins_pL))));
			info2->AddText(TString::Format("NLO #chi^{2}/ndf=%.0f/%u=%.2f, p_{val}=%.3f",
					Chi2_pL_NLO,EffNumBins_pL,Chi2_pL_NLO/double(EffNumBins_pL),TMath::Prob(Chi2_pL_NLO,round(EffNumBins_pL))));
			...
			if(vSource==0)
				info3->AddText(TString::Format("R(%s)=%.3f#pm%.3f",SOURCE_NAME.Data(),
						fitter->GetParameter("LambdaLambda",DLM_Fitter1::p_sor0),fitter->GetParError("LambdaLambda",DLM_Fitter1::p_sor0)));
			...
			info3->AddText(TString::Format("Local #chi^{2}/ndf=%.0f/%u=%.2f, p_{val}=%.3f",
					Chi2_LL,EffNumBins_LL,Chi2_LL/double(EffNumBins_LL),TMath::Prob(Chi2_LL,round(EffNumBins_LL))));
			info3->AddText(TString::Format("STAR #chi^{2}/ndf=%.0f/%u=%.2f, p_{val}=%.3f",
					Chi2_LL_STAR,EffNumBins_LL,Chi2_LL_STAR/double(EffNumBins_LL),TMath::Prob(Chi2_LL_STAR,round(EffNumBins_LL))));
			...
			if(ExcludeXi==false){
				...
				double pvalXiCoulomb=TMath::Prob(Chi2_pXim_COULOMB,round(EffNumBins_pXim));
				...
				info4->AddText(TString::Format("R(%s)=%.3f#pm%.3f",SOURCE_NAME.Data(),
						fitter->GetParameter("pXim",DLM_Fitter1::p_sor0),fitter->GetParError("pXim",DLM_Fitter1::p_sor0)));
				...
				info4->AddText(TString::Format("Local #chi^{2}/ndf=%.0f/%u=%.2f, p_{val}=%.5f, n#sigma=%.3f",
						Chi2_pXim,EffNumBins_pXim,Chi2_pXim/double(EffNumBins_pXim),pvalXi,nSigmaXi));
				info4->AddText(TString::Format("Coulomb #chi^{2}/ndf=%.0f/%u=%.2f, p_{val}=%.5f, n#sigma=%.3f",
						Chi2_pXim_COULOMB,EffNumBins_pXim,Chi2_pXim_COULOMB/double(EffNumBins_pXim),pvalXiCoulomb,nSigmaXiCoulomb));
			}
